...
con_string = "mongodb+srv://narmadha:narmadha@cluster0.uph3xau.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('database1')

user_collection = pymongo.collection.Collection(db, 'user1') #(<database_name>,"<collection_name>")
